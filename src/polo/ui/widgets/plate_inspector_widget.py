...
from polo.ui.designer.UI_plate_inspector_widget import Ui_PlateInspector
...
class PlateInspectorWidget(QtWidgets.QWidget):
    ...
    def apply_plate_settings(self):
        ...
        '''
        if self.__run:
            self.ui.plateViewer.images_per_page = int(
    ...
    def show_current_plate(self, next_date=False, prev_date=False, alt_spec=False):
        self.ui.plateViewer.tile_graphics_wells(
