...
# Form implementation generated from reading ui file '/home/ethan/Documents/github/HWI/Marco_Polo/pyqt_designer/FTP_Dialog.ui'
#
...
class Ui_FTPDialog(object):
    ...
    def retranslateUi(self, FTPDialog):
        ...
        self.lineEdit_3.setToolTip(_translate("FTPDialog", "<html><head/><body><p>FTP server address.</p></body></html>"))
        self.lineEdit_3.setText(_translate("FTPDialog", "ftp.hwi.buffalo.edu"))
        self.groupBox.setTitle(_translate("FTPDialog", "FTP Login"))
        self.pushButton_3.setText(_translate("FTPDialog", "Cancel"))
        self.pushButton.setToolTip(_translate("FTPDialog", "<html><head/><body><p>Attempt connection to the FTP server.</p></body></html>"))
        self.pushButton.setText(_translate("FTPDialog", "Connect"))
        self.lineEdit_2.setToolTip(_translate("FTPDialog", "<html><head/><body><p>Your password for the FTP server specified in the <span style=\" font-weight:600;\">Enter Host</span> box.</p></body></html>"))
        self.label.setText(_translate("FTPDialog", "Username"))
        self.lineEdit.setToolTip(_translate("FTPDialog", "<html><head/><body><p>Your username for the FTP server specified in the <span style=\" font-weight:600;\">Enter Host </span>box.</p></body></html>"))
        self.label_2.setText(_translate("FTPDialog", "Password"))
        self.groupBox_3.setTitle(_translate("FTPDialog", "Connection Status"))
        self.label_3.setToolTip(_translate("FTPDialog", "<html><head/><body><p>Your current connection status. Will display <span style=\" font-weight:600;\">Connected</span> if you successfully connect to a FTP server.</p></body></html>"))
        self.label_3.setText(_translate("FTPDialog", "Disconnected "))
        self.groupBox_2.setTitle(_translate("FTPDialog", "File Browser"))
        self.pushButton_2.setToolTip(_translate("FTPDialog", "<html><head/><body><p>Download all selected files and directories in the background. </p><p><br/></p><p><span style=\" font-weight:600;\">Note</span>: The FTP downloader does not currently replicate the remote directory structure, it just dumps all your files into whatever directory has been selected on your local machine.  </p></body></html>"))
