...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton.setToolTip(_translate("Form", "<html><head/><body><p>Run the MARCO model on the currently selected run. </p><p>MARCO has been trained on visible light images and will only run on runs photographed using standard visible light imaging.</p><p><br/></p></body></html>"))
