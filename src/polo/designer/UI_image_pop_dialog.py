...
# Form implementation generated from reading ui file '/home/ethan/Documents/github/HWI/Marco_Polo/pyqt_designer/image_pop_dialog.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_2.setToolTip(_translate("Dialog", "<html><head/><body><p>Classify current image as crystal.</p><p>Shortcut: <span style=\" font-weight:600;\">1</span></p><p><br/></p></body></html>"))
        self.pushButton_2.setText(_translate("Dialog", "Crystal"))
        self.pushButton_2.setShortcut(_translate("Dialog", "1"))
        self.pushButton_5.setToolTip(_translate("Dialog", "<html><head/><body><p>Classify current image as precipitate.</p><p>Shortcut: <span style=\" font-weight:600;\">3</span></p><p><br/></p></body></html>"))
        self.pushButton_5.setText(_translate("Dialog", "Precipitate"))
        self.pushButton_5.setShortcut(_translate("Dialog", "3"))
        self.pushButton_4.setToolTip(_translate("Dialog", "<html><head/><body><p>Classify current image as other.</p><p>Shortcut: <span style=\" font-weight:600;\">4</span></p></body></html>"))
        self.pushButton_4.setText(_translate("Dialog", "Other"))
        self.pushButton_4.setShortcut(_translate("Dialog", "4"))
        self.pushButton_3.setToolTip(_translate("Dialog", "<html><head/><body><p>Classify current image as clear.</p><p>Shortcut: <span style=\" font-weight:600;\">2</span></p></body></html>"))
        self.pushButton_3.setText(_translate("Dialog", "Clear"))
        self.pushButton_3.setShortcut(_translate("Dialog", "2"))
        self.radioButton.setToolTip(_translate("Dialog", "<html><head/><body><p>Mark image as a favorite.</p><p><br/></p><p>Shortcut:<span style=\" font-weight:600;\"> F</span></p></body></html>"))
        self.radioButton.setText(_translate("Dialog", "Favorite?"))
        self.radioButton.setShortcut(_translate("Dialog", "F"))
